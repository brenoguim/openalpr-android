# openalpr-android
[![Release](https://jitpack.io/v/SandroMachado/openalpr-android.svg)](https://jitpack.io/#brenoguim/openalpr-android)
...
dependencies {
    ...
    compile 'com.github.SandroMachado:openalpr-android:2.0.0'
}
```
